...
## Corpus Check
- 6 files · ~32,947 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22 nodes · 21 edges · 2 communities detected
...
## Knowledge Gaps
- **Thin community `Community 0`** (7 nodes): `McPluginsDashboard.tsx`, `dedupeHistoryNewestFirst()`, `fetchJson()`, `fmtBytes()`, `onSubmit()`, `pinLookupKey()`, `serverFromPath()`
